...
```
git clone https://github.com/Immersive-DataEngineer-Resource/Algo-DS-Part2.git
```

setelah clone selesai, jalankan perintah `cd Algo-DS-Part2` --> **HAL INI DILAKUKAN 1x saja**
...
buat repository pada github organization kalian dengan format: `Algo-DS-Part2`
